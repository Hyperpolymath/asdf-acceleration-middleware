= RSR Compliance: asdf-acceleration-middleware
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *asdf-acceleration-middleware*.
